function [monkey_inventory, monkey_activity] = monkeyturn_w (monkeynumber, monkey_inventory_old, monkey_activity)

monkey_inventory= monkey_inventory_old;

primeproduct = 7*19*5*11*17*13*2*3;
